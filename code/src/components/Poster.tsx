...
const Poster: React.FC<PosterProps> = ({
  ...
  return (
    <div className="group relative w-full md:w-80 bg-gray-800 rounded-xl shadow-lg overflow-hidden flex flex-col transition-transform duration-300 hover:scale-105 my-4 z-0 hover:z-20">
      ...
      <div className="relative w-full overflow-hidden aspect-w-16 aspect-h-9 md:aspect-w-2 md:aspect-h-3">
        <img
        ...
        <div className="p-4 flex flex-col flex-grow text-white">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-2">
              <button className="h-8 w-8 flex items-center justify-center rounded-full bg-white text-black hover:bg-opacity-80 focus:outline-none focus:ring-2 focus:ring-white">
                <BsPlayFill size={24} />
              </button>
              <button className="h-8 w-8 flex items-center justify-center rounded-full border-2 border-gray-400 text-gray-300 hover:border-white hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-400">
                <BsPlus size={24} />
              </button>
              <button className="h-8 w-8 flex items-center justify-center rounded-full border-2 border-gray-400 text-gray-300 hover:border-white hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-400">
